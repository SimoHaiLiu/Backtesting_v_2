...
from trader.app.strategyTrading.strBacktesting import BacktestingEngine, MINUTE_DB_NAME, OptimizationSetting
...
if __name__ == '__main__':
    ...
    # 多进程优化，耗时：89秒
    result = engine.runParallelOptimization(RsiStrategy, setting)
